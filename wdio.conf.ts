...
export const config: Options.Testrunner = {
    ...
    //
    specs: [
        './TOZTEST/ROOT/POM/features/*/*.feature'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        ...
        "goog:chromeOptions":{args: ["--start-maximized", "--disable-web-security", "--disable-dev-shm-usage", "--disable-gpu-sandbox", "--window-size:2220,1080", "--no-sandbox"]
        },
    ...
    cucumberOpts: {
        ...
        require: ['./TOZTEST/ROOT/POM/features/*/stepDefinition/*.ts'],
    ...
    before: function (capabilities, specs) {
        browser.options["Environment"] = config.runnerEnv
        browser.options["TOZ_DEV_URL"] = config.runnerEnv
    },
    /**
    ...
    afterFeature: function (uri, feature) {
        ...
        AllureReporter.addEnvironment("Browser Name : ", browser.options.hostname)
    },
    /**
